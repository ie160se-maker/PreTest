...
function screenInstructions() {
    show(
      ...
      '<p>各投稿は、Instagramでよく見られる<strong>カルーセル（複数枚の画像）とキャプション（画像下の文章）</strong>で構成されています。' +
      ...
      '<ul class="notes">' +
      '<li>カルーセルは、左右のスワイプ（またはボタン）で next へ進みます。</li>' +
 ...
 function screenStimulus() {
    ...
    show(
      ...
      '<p><strong>1枚1枚のカルーセルおよびキャプションを最後までしっかり読んでください。</strong>' +
      '十分にカルーセルとキャプションを読まないと、<strong>次に進めない仕様になっています。</strong></p>' +
